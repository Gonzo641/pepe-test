...
const Header = () => {
  ...
  const [linkColor, setLinkColor] = useState('#fcfeff');
        ...
        <div className="flex items-center justify-center flex-grow ml-10">
          ...
          {links.map((link) => (
                      ...
                      >
                        <Link
                          className={clsx(
                            "flex w-full items-center justify-center px-3 py-3 text-white hover:text-gray-400 transition",
                            {
                              "text-gray-950":
                        ...
                        >
                          ...
                          {/* {link.name === activeSection && (
                            <motion.span
                              className="border border-slate-400 bg-slate-50 rounded-full absolute inset-0 -z-10"
          ...
          <div className="ml-auto hidden md:flex">
            {!session && (
              <div onClick={() => signIn()} className="headerDiv bg-black hover:bg-black cursor-pointer">
      ...
      >
        ...
        >
          <div>
            ...
            <Link href={"/"}>
                <h3 className="text-3xl font-semibold text-gray-500 z-0 hover:text-red-600
